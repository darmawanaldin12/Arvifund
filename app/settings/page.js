        ...
        <div className="card" style={{ marginBottom: 16 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6, fontSize: 13, color: 'var(--text3)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Versi</span>
              <span style={{ color: 'var(--text1)', fontWeight: 600 }}>2.0.0</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Platform</span>
              <span style={{ color: 'var(--text1)', fontWeight: 600 }}>Next.js + Supabase</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Database</span>
              <span style={{ color: 'var(--text1)', fontWeight: 600 }}>PostgreSQL</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Input</span>
              <span style={{ color: 'var(--text1)', fontWeight: 600 }}>Telegram Bot + n8n</span>
            </div>
          </div>
        </div>
