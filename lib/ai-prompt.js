...
3. Jika metode pembayaran adalah "Cash" → bank = "Cash". WAJIB.
4. SELAIN itu (misal struk hanya menampilkan metode "QRIS", "Cardless", "Card", "Debit", pembayaran digital tanpa nama bank, atau kalimat sama sekali tidak menyebut sumber dana/rekening) → DEFAULT bank = "BCA". JANGAN PERNAH menaruh "QRIS"/"Card"/"Cardless"/"Transfer" pada field bank.
...
✅ "beli jajan 5rb" (bayar pakai uang tunai/dompet) → metode: "Cash", bank: "Cash"
✅ "beli sesuatu cash" → metode: "Cash", bank: "Cash"
❌ bank: "QRIS" → SALAH, QRIS adalah metode bukan nama rekening
❌ bank: "Card" / "Cardless" / "Transfer" → SALAH, itu metode bukan rekening
❌ metode: "Cash" tapi bank: "BCA" → SALAH, kalau metode Cash maka bank juga harus "Cash"
