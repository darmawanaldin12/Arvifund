...
// Set saldo baseline manual — simpan ke kolom balance + timestamp
...
export async function getAllDashboardData() {
  const [expenses, income, allExpenses, allIncome, cashRecords, budgetPlans, profiles, transfers, accounts] = await Promise.all([
    getExpenses(),
    getIncome(),
  ...
  return { expenses, income, allExpenses, allIncome, cashRecords, budgetPlans, profiles, transfers, accounts }
}
